...
@Component({
  ...
  host: { class: 'shrink-0' },
  styles: [`
    :host{display:block;width:min(100%,620px);min-width:0}.workflow-nav{min-height:44px;padding:3px;display:flex;align-items:center;gap:2px;overflow-x:auto;scrollbar-width:none;border:1px solid var(--op-border,#cfdae7);border-radius:12px;background:var(--op-panel-strong,#dfe9f3)}.workflow-nav::-webkit-scrollbar{display:none}.workflow-link{position:relative;min-height:36px;padding:0 11px;display:flex;align-items:center;gap:7px;flex:none;border-radius:9px;color:var(--op-muted,#60738a);font-size:11px;font-weight:700;transition:background var(--motion-press,130ms) var(--ease-standard,ease),color var(--motion-press,130ms) var(--ease-standard,ease),box-shadow var(--motion-selection,170ms) var(--ease-standard,ease),transform var(--motion-press,130ms) var(--ease-standard,ease)}.workflow-link:hover{background:rgb(255 255 255/.65);color:var(--op-ink,#12233b)}.workflow-link:active:not(.is-disabled){transform:scale(.985)}.workflow-link.is-active{background:#fff;color:var(--op-blue,#0369a1);box-shadow:0 1px 3px rgb(18 35 59/.1)}.workflow-link.is-disabled{opacity:.35;pointer-events:none}.workflow-link svg{width:16px;height:16px;flex:none}.complete-dot{width:6px;height:6px;border-radius:50%;background:#0f8063}.preview-badge{margin-left:4px;padding:4px 7px;border-radius:999px;background:#e0f2fe;color:#0369a1;font:700 9px ui-sans-serif,sans-serif}@media(max-width:767.98px){:host{width:100%}.workflow-nav{width:100%}.workflow-link{min-width:42px;flex:1;justify-content:center;padding-inline:8px}.workflow-link span:not(.complete-dot){display:none}}
  `],
  template: `
