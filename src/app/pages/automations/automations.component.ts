...
@Component({
  ...
  styles: [`
    :host{--op-shell:#fbfcfa;--op-panel:#f3f6f2;--op-border:#d7ded8;--op-ink:#152019;--op-muted:#68756d;--color-base-100:var(--op-shell);--color-base-200:var(--op-panel);--color-base-300:var(--op-border);--color-base-content:var(--op-ink);--color-primary:var(--op-brand,#0284c7);--color-primary-content:#fff}.page{display:flex;flex:1;min-width:0;min-height:0;flex-direction:column;background:var(--op-shell);color:var(--op-ink)}.context{height:64px;min-height:64px;padding:0 24px;display:flex;align-items:center;border-bottom:1px solid var(--op-border);background:rgb(251 252 250/.96)}.context h1{margin:0;font-size:18px;font-weight:800}.context p{margin:3px 0 0;color:var(--op-muted);font-size:11px}.scroll{flex:1;min-height:0;overflow:auto}.page-intro{margin-bottom:20px}.page-intro h2{margin:0;font-size:20px;font-weight:800}.page-intro p{max-width:42rem;margin:5px 0 0;color:var(--op-muted);font-size:13px;line-height:1.5}.manager-surface{padding:20px;border:1px solid var(--op-border);border-radius:18px;background:#fff}@media(max-width:767.98px){.context{display:none}.manager-surface{padding:14px;border-radius:15px}}
  `],
  template: `
    <div class="page">
