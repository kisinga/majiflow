...
@Component({
  ...
  styles: [`
    :host{display:block;flex:1;min-width:0;min-height:0}app-route-card{--color-primary:var(--op-blue,#0369a1);--color-primary-content:#fff}button{font:inherit}button:focus-visible{outline:3px solid color-mix(in srgb,var(--op-blue,#0369a1) 34%,transparent);outline-offset:2px}
    .workspace{--line:var(--op-border,#cfdae7);position:relative;display:grid;grid-template-columns:320px minmax(0,1fr);width:100%;height:100%;min-height:31rem;overflow:hidden;border-top:1px solid var(--line);background:var(--op-canvas,#eaf2f8);color:var(--op-ink,#12233b)}
    .operator-rail{min-width:0;min-height:0;display:grid;grid-template-rows:auto minmax(0,1fr);border-right:1px solid var(--line);background:var(--op-panel,#edf3f8)}
    .rail-header{min-width:0;padding:12px 14px 14px;border-bottom:1px solid var(--line)}.rail-tabs{display:grid;grid-template-columns:1fr 1fr;gap:4px;padding:4px;border:1px solid var(--line);border-radius:13px;background:var(--op-panel-strong,#dfe9f3)}.rail-tab{min-height:44px;padding:0 10px;display:flex;align-items:center;justify-content:center;gap:7px;border-radius:9px;color:var(--op-muted,#60738a);font-size:12px;font-weight:800;transition:background var(--motion-selection,170ms) var(--ease-standard,ease),color var(--motion-selection,170ms) var(--ease-standard,ease),box-shadow var(--motion-selection,170ms) var(--ease-standard,ease)}.rail-tab svg{width:17px;height:17px;flex:none}.rail-tab.is-active{background:#fff;color:var(--op-blue,#0369a1);box-shadow:0 1px 3px rgb(18 35 59/.1)}
    .eyebrow{color:var(--op-muted,#60738a);font-size:10px;line-height:1;font-weight:800;letter-spacing:.12em;text-transform:uppercase}.rail-title{display:flex;align-items:flex-end;gap:8px;margin-top:15px}.rail-title-copy{min-width:0}.rail-title h2{margin:7px 0 0;font-size:19px;line-height:1.2;font-weight:800}.rail-title>span{margin-left:auto;padding-bottom:2px;color:var(--op-muted,#60738a);font-size:12px;white-space:nowrap}
    .manual-gate{box-sizing:border-box;width:100%;min-height:62px;margin-top:13px;padding:8px 11px;display:flex;align-items:center;gap:11px;border:1px solid var(--line);border-radius:12px;background:#fff;text-align:left;transition:border-color var(--motion-selection,170ms) var(--ease-standard,ease),background var(--motion-selection,170ms) var(--ease-standard,ease),transform var(--motion-press,130ms) var(--ease-standard,ease)}.manual-gate:hover:not(:disabled){border-color:color-mix(in srgb,var(--op-muted,#60738a) 45%,var(--line))}.manual-gate:active:not(:disabled){transform:scale(.992)}.manual-gate.is-armed{border-color:color-mix(in srgb,var(--op-amber,#b76108) 48%,var(--line));background:#fff3d9}.manual-gate:disabled{cursor:not-allowed}.gate-icon{width:36px;height:36px;flex:none;display:grid;place-items:center;border-radius:10px;background:var(--op-panel-strong,#dfe9f3);color:var(--op-muted,#60738a);transition:background var(--motion-selection,170ms) var(--ease-standard,ease),color var(--motion-selection,170ms) var(--ease-standard,ease)}.gate-icon svg{width:18px;height:18px}.manual-gate.is-armed .gate-icon{background:#ffe7b0;color:var(--op-amber,#b76108)}.gate-copy{min-width:0;flex:1}.gate-copy strong{display:block;font-size:12px;line-height:1.25}.gate-copy span{display:block;margin-top:3px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;color:var(--op-muted,#60738a);font-size:9px;line-height:1.35}.gate-switch{position:relative;width:40px;height:24px;flex:none;border-radius:999px;background:var(--op-panel-strong,#dfe9f3);box-shadow:inset 0 0 0 1px var(--line);transition:background var(--motion-selection,170ms) var(--ease-standard,ease),box-shadow var(--motion-selection,170ms) var(--ease-standard,ease)}.gate-switch::after{content:'';position:absolute;top:3px;left:3px;width:18px;height:18px;border-radius:50%;background:#fff;box-shadow:0 1px 3px rgb(18 35 59/.25);transition:transform var(--motion-selection,170ms) var(--ease-standard,ease)}.manual-gate.is-armed .gate-switch{background:var(--op-amber,#b76108);box-shadow:none}.manual-gate.is-armed .gate-switch::after{transform:translateX(16px)}
    .stop-all{min-height:48px;width:100%;margin-top:14px;padding:0 12px;border:1px solid color-mix(in srgb,var(--op-red,#c93636) 62%,transparent);border-radius:11px;color:var(--op-red,#c93636);background:#fff;font-size:13px;font-weight:800;transition:background var(--motion-press,130ms) var(--ease-standard,ease),transform var(--motion-press,130ms) var(--ease-standard,ease)}.stop-all:hover:not(:disabled){background:color-mix(in srgb,var(--op-red,#c93636) 6%,#fff)}.stop-all:active:not(:disabled){transform:scale(.985)}.stop-all:disabled{color:color-mix(in srgb,var(--op-red,#c93636) 42%,var(--op-muted,#60738a));border-color:var(--line);background:transparent;cursor:not-allowed}
    .rail-scroll{min-width:0;min-height:0;overflow-y:auto;padding:14px;display:flex;flex-direction:column;align-items:stretch;gap:10px;scrollbar-gutter:stable}.route-controller,.entity-group{margin:7px 3px -2px;color:var(--op-muted,#60738a);font-size:10px;font-weight:800;letter-spacing:.09em;text-transform:uppercase}.empty{margin:auto;padding:24px 12px;color:var(--op-muted,#60738a);text-align:center;font-size:13px;line-height:1.45}
    .entity-row{min-height:58px;width:100%;padding:8px 12px;display:flex;align-items:center;gap:12px;border:1px solid var(--line);border-radius:12px;background:#fff;text-align:left;touch-action:pan-y;transition:border-color var(--motion-selection,170ms) var(--ease-standard,ease),background var(--motion-selection,170ms) var(--ease-standard,ease),transform var(--motion-press,130ms) var(--ease-standard,ease),box-shadow var(--motion-selection,170ms) var(--ease-standard,ease)}.entity-row:hover,.entity-row.is-selected{border-color:color-mix(in srgb,var(--op-green,#0f8063) 55%,var(--line));background:var(--op-green-surface,#ddf5ec)}.entity-row:active{transform:scale(.995)}.entity-row.is-held{border-color:color-mix(in srgb,var(--op-blue,#0369a1) 55%,var(--line));background:var(--op-blue-surface,#dff2fe)}.entity-row.is-pending,.entity-row.is-warning{border-color:color-mix(in srgb,var(--op-amber,#b76108) 48%,var(--line));background:#fff3d9}.entity-row.is-fault{border-color:color-mix(in srgb,var(--op-red,#c93636) 45%,var(--line));background:#feebea}.entity-row.is-offline{background:var(--op-shell,#f6f9fc)}.entity-row.is-disabled{cursor:default}.entity-row:focus-visible{outline:3px solid color-mix(in srgb,var(--op-blue,#0369a1) 34%,transparent);outline-offset:2px}
    .entity-row-copy{min-width:0;flex:1}.entity-row-copy strong{display:block;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;font-size:13px}.entity-row-copy span{display:block;margin-top:3px;overflow:hidden;white-space:nowrap;text-overflow:ellipsis;color:var(--op-muted,#60738a);font-size:10px}.entity-reading{font-variant-numeric:tabular-nums}.entity-state{max-width:62px;flex:none;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;color:var(--op-muted,#60738a);font-size:10px;font-weight:700}.entity-state.is-live{color:var(--op-blue,#0369a1)}.entity-row.is-pending .entity-state,.entity-row.is-warning .entity-state{color:var(--op-amber,#b76108)}.entity-row.is-fault .entity-state{color:var(--op-red,#c93636)}
    .entity-control{position:relative;width:36px;height:36px;flex:none;display:grid;place-items:center;overflow:hidden;border:1px solid var(--line);border-radius:50%;background:#fff;color:var(--op-muted,#60738a);transition:border-color var(--motion-selection,170ms) var(--ease-standard,ease),color var(--motion-selection,170ms) var(--ease-standard,ease),background var(--motion-selection,170ms) var(--ease-standard,ease)}.entity-control svg{position:relative;z-index:2;width:22px;height:22px;overflow:visible}.entity-control.can-start{border-color:color-mix(in srgb,var(--op-green,#0f8063) 42%,var(--line));color:var(--op-green,#0f8063);background:var(--op-green-surface,#ddf5ec)}.entity-control.release{border-color:color-mix(in srgb,var(--op-blue,#0369a1) 48%,var(--line));color:var(--op-blue,#0369a1);background:var(--op-blue-surface,#dff2fe)}.entity-row.is-pending .entity-control,.entity-row.is-warning .entity-control{border-color:var(--op-amber,#b76108);color:var(--op-amber,#b76108);background:#ffe7b0}.entity-row.is-fault .entity-control{border-color:var(--op-red,#c93636);color:var(--op-red,#c93636);background:#fbd9d7}.entity-row.is-offline .entity-control{border-color:var(--line);color:var(--op-muted,#60738a);background:var(--op-panel-strong,#dfe9f3)}.entity-control.is-holding{border-color:var(--op-amber,#b76108);color:#fff;background:var(--op-amber,#b76108)}.entity-control.is-holding::before{content:'';position:absolute;inset:0;background:rgb(255 255 255/.28);transform:scaleY(0);transform-origin:bottom;animation:hold-progress 900ms linear forwards}@keyframes hold-progress{to{transform:scaleY(1)}}
    .entity-reason{margin:-5px 8px 3px;padding-left:48px;color:var(--op-red,#c93636);font-size:10px;line-height:1.35}.hold-summary{margin-top:8px;padding:9px 10px;display:flex;align-items:center;justify-content:space-between;gap:8px;border-radius:9px;background:var(--op-blue-surface,#dff2fe);color:var(--op-blue,#0369a1);font-size:10px;font-weight:750}.hold-summary span:last-child{font-weight:600;color:var(--op-muted,#60738a)}
    .map-pane{position:relative;min-width:0;min-height:0;overflow:hidden;background:var(--op-canvas,#eaf2f8)}.map-status{position:absolute;z-index:12;top:14px;left:14px;max-width:calc(100% - 190px);min-height:44px;padding:8px 12px;display:inline-flex;align-items:center;gap:9px;border:1px solid var(--line);border-radius:11px;background:rgb(255 255 255/.9);box-shadow:0 7px 20px rgb(18 35 59/.08);backdrop-filter:blur(10px);font-size:12px;font-weight:700}.map-status span:last-child{overflow:hidden;white-space:nowrap;text-overflow:ellipsis}.status-dot{width:9px;height:9px;flex:none;border-radius:50%;background:var(--op-green,#0f8063);box-shadow:0 0 0 5px color-mix(in srgb,var(--op-green,#0f8063) 12%,transparent)}.map-stop{display:none}.mobile-tabs{display:none}
    @media (min-width:768px) and (max-width:1279.98px){.workspace{grid-template-columns:280px minmax(0,1fr)}}
    @media (max-width:767.98px){:host{min-height:0}.workspace{display:flex;flex-direction:column;min-height:0;height:100%;border:0}.mobile-tabs{position:relative;z-index:20;display:grid;grid-template-columns:1fr 1fr;gap:4px;padding:7px;border-bottom:1px solid var(--line);background:var(--op-panel,#edf3f8)}.mobile-tab{min-height:44px;border-radius:11px;color:var(--op-muted,#60738a);font-size:13px;font-weight:800}.mobile-tab.active{background:#fff;color:var(--op-blue,#0369a1);box-shadow:0 1px 3px rgb(18 35 59/.12),inset 0 0 0 1px var(--line)}.operator-rail{display:grid;flex:1;border:0}.operator-rail.hidden-mobile{display:none}.map-pane{flex:1;min-height:31rem}.map-pane.hidden-mobile{position:absolute;inset:59px 0 0;visibility:hidden;pointer-events:none}.rail-header{padding:10px 12px 13px}.rail-scroll{padding:12px;overflow-y:auto}.map-status{top:64px;left:12px;max-width:calc(100% - 24px)}.map-stop{position:absolute;z-index:14;top:12px;left:12px;display:block;min-height:44px;padding:0 12px;border:1px solid color-mix(in srgb,var(--op-red,#c93636) 60%,transparent);border-radius:11px;background:rgb(255 255 255/.92);color:var(--op-red,#c93636);font-size:12px;font-weight:800}}
