...
@Component({
  ...
  host: { class: 'block' },
  styles: [`
    :host{--line:var(--op-border,#d7ded8);color:var(--op-ink,#152019)}button{font:inherit}.settings-layout{display:grid;grid-template-columns:220px minmax(0,1fr);gap:24px;align-items:start}.settings-nav{position:sticky;top:16px;display:flex;flex-direction:column;gap:4px;padding:6px;border:1px solid var(--line);border-radius:15px;background:var(--op-panel,#f3f6f2)}.settings-nav button{min-height:54px;padding:9px 11px;display:flex;align-items:center;gap:10px;border-radius:10px;color:var(--op-muted,#68756d);text-align:left;transition:background var(--motion-selection,170ms) var(--ease-standard,ease),color var(--motion-selection,170ms) var(--ease-standard,ease),box-shadow var(--motion-selection,170ms) var(--ease-standard,ease)}.settings-nav button:hover{color:var(--op-ink,#152019);background:rgb(255 255 255/.58)}.settings-nav button.is-active{color:var(--op-brand-deep,#0369a1);background:#fff;box-shadow:0 1px 3px rgb(21 32 25/.1)}.settings-nav svg{width:19px;height:19px;flex:none;stroke-linecap:round;stroke-linejoin:round}.nav-copy{min-width:0}.nav-copy strong{display:block;font-size:12px}.nav-copy span{display:block;margin-top:2px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:9px;font-weight:500;color:var(--op-muted,#68756d)}
    .settings-content{min-width:0;min-height:27rem;border:1px solid var(--line);border-radius:18px;background:#fff;overflow:hidden}.section-head{padding:22px 24px 18px;border-bottom:1px solid var(--line)}.section-head h3{margin:0;font-size:17px;font-weight:800}.section-head p{max-width:44rem;margin:5px 0 0;color:var(--op-muted,#68756d);font-size:12px;line-height:1.5}.section-body{padding:22px 24px;animation:settings-section-in var(--motion-panel,230ms) var(--ease-enter,ease) both}@keyframes settings-section-in{from{opacity:0;transform:translateY(4px)}}.section-note{margin:0 0 16px;padding:11px 13px;border-left:3px solid var(--op-brand,#0284c7);border-radius:0 9px 9px 0;background:var(--op-blue-soft,#e0f2fe);color:var(--op-muted,#68756d);font-size:11px;line-height:1.5}.section-note.warning{border-color:var(--op-amber,#a85c0e);background:#fff8eb;color:#70410d}.empty{padding:48px 20px;text-align:center;color:var(--op-muted,#68756d);font-size:12px}
    .controller-list{display:flex;flex-direction:column;gap:10px}.controller-card{padding:15px;border:1px solid var(--line);border-radius:13px;background:var(--op-shell,#fbfcfa);transition:border-color var(--motion-selection,170ms) var(--ease-standard,ease),background var(--motion-selection,170ms) var(--ease-standard,ease)}.controller-card.is-live{border-color:color-mix(in srgb,var(--op-red,#b42318) 45%,var(--line));background:#fef3f2}.controller-row{display:flex;align-items:center;gap:10px}.presence{width:8px;height:8px;flex:none;border-radius:50%;background:var(--op-muted,#68756d)}.presence.online{background:var(--op-green,#147448);box-shadow:0 0 0 4px color-mix(in srgb,var(--op-green,#147448) 12%,transparent)}.controller-name{min-width:0;flex:1}.controller-name strong{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:13px}.controller-name span{display:block;margin-top:2px;color:var(--op-muted,#68756d);font-size:10px}.override-button{min-width:72px;min-height:44px;padding:0 12px;border:1px solid var(--line);border-radius:10px;background:#fff;color:var(--op-muted,#68756d);font-size:11px;font-weight:800}.override-button.is-live{border-color:var(--op-red,#b42318);background:var(--op-red,#b42318);color:#fff}.override-button:disabled{opacity:.55;cursor:not-allowed}.override-warning{margin:12px 0 0;padding-top:11px;border-top:1px solid color-mix(in srgb,var(--op-red,#b42318) 22%,var(--line));color:var(--op-red,#b42318);font-size:11px;line-height:1.45}
