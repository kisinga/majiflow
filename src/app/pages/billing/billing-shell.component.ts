...
@Component({
  ...
  styles: [`
    :host{--color-base-100:var(--op-shell);--color-base-200:var(--op-panel);--color-base-300:var(--op-border);--color-base-content:var(--op-ink)}.billing-page{display:flex;flex:1;min-width:0;min-height:0;flex-direction:column;background:transparent;color:var(--op-ink)}.billing-context{height:64px;min-height:64px;padding:0 24px;display:flex;align-items:center;border-bottom:1px solid var(--op-border);background:rgb(255 255 255/.88);box-shadow:0 5px 18px rgb(18 35 59/.045);backdrop-filter:blur(16px) saturate(1.2)}.billing-context h1{margin:0;font-size:18px;font-weight:800}.billing-context p{margin:3px 0 0;color:var(--op-muted);font-size:11px}.billing-scroll{flex:1;min-height:0;overflow:auto}.billing-content{display:flex;flex-direction:column;gap:20px}@media(max-width:767.98px){.billing-context{display:none}}
  `],
  template: `
